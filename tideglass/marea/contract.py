...
PUBLIC_API: frozenset[str] = frozenset({
    "GPD", "Advice", "CATALOG", "Constituent", "GaugeStore", "HealthMonitor",
    "HealthReport", "HierarchicalPool", "JointModel", "KrigeField",
    "NowcastEngine", "OpsReport", "PooledConstituent", "Prediction",
    "ResponseTransfer", "SkewSurge", "StationWatch", "TideAdvisor", "TideModel",
    ...
    "coverage_report", "crps_gaussian", "decluster", "evaluate_calibration",
    "find", "fit_gpd", "flood_probability", "format_self_check", "get",
    "global_model_at", "joint_exceedance_probability", "krige_field",
    "krige_regional", "list_packs", "list_regions", "load_pack_dir",
    "load_pack_file", "load_station", "marea", "marine", "native_to_model",
    "pit_histogram", "pit_values", "poll", "principal", "read_harmonic_grid",
