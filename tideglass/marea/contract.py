...
PUBLIC_API: frozenset[str] = frozenset({
    ...
    "Prediction", "PeerBundle", "PeerDelta", "PeerTrustScore", "SurgeResponse",
    "ResponseTransfer", "SkewSurge", "StationWatch",
    ...
    "AltimetryTrack", "WorldModel", "WorldPrediction",
